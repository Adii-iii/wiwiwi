...
const SEnvelopeGrid = ({ blocks, onBlockClick }) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-8 p-10 max-w-5xl mx-auto">
